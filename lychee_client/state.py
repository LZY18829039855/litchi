...
MAX_TASK_DETOUR_COST = 8
MAX_TASK_DETOUR_CEILING = 50
ROUTE_TASK_BONUS_PER_SCORE = 14
ROUTE_TASK_COUNT_BONUS = 50
ROUTE_HIGH_VALUE_TASK_BONUS = 60
...
ICE_BOX_FRESHNESS_THRESHOLD = 88
MAX_ROUND = 600
SQUAD_CLEAR_COST = 2
SQUAD_RESERVE_FOR_LATE = 4
SQUAD_CLEAR_MIN_SQUAD = SQUAD_CLEAR_COST + SQUAD_RESERVE_FOR_LATE
SQUAD_CLEAR_NEXT_HOP_RESERVE = 2
SQUAD_CLEAR_NEXT_HOP_MIN_SQUAD = SQUAD_CLEAR_COST + SQUAD_CLEAR_NEXT_HOP_RESERVE
GATE_CORRIDOR_NODES = frozenset({"S10", "S11", "S12", "S13", "S14"})
GATE_CORRIDOR_ORDER = ("S10", "S11", "S12", "S13", "S14")
GATE_CORRIDOR_SQUAD_MIN = SQUAD_CLEAR_COST
MAX_ACTIVE_GUARDS = 2
GUARD_GOOD_FRUIT_RESERVE = 2
GUARD_MIN_LEAD_FIRST = 2
GUARD_RESERVE_FOR_GATE = 1
FINAL_CORRIDOR_GATE_HOPS = 12
ICE_BOX_NEAR_GATE_HOPS = 8
...
SQUAD_CLEAR_MIDMAP_MIN_ROUND = 120
...
FINAL_CORRIDOR_GUARD_TASK_MIN = 60
GATE_DELAY_GUARD_MIN_OPP_HOPS = 4
GATE_DELAY_GUARD_EXTRA_FRUIT = 1
GUARD_STUCK_AVOID_ROUNDS = 30
GUARD_SILENT_WAIT_LIMIT = 10
FORCE_DELIVERY_ETA_BUFFER = 22
FORCE_DELIVERY_MIN_REMAINING = 250
FORCE_DELIVERY_ETA_REMAINING_MAX = 350
FORCE_DELIVERY_LATE_REMAINING = 100
RUSH_TASK_DETOUR_BONUS = 5
RUSH_PROTECT_FRESHNESS = 50
INTEL_MAX_DISTANCE = 15
WATER_ROUTE_TASK_MIN = 60
